...
async function renewAccessToken(incomingRefreshToken: string) {
...
async function changePassword(
  ...
  const isPasswordCorrect = await user!.isPasswordCorrect(password.oldPassword);
...
export { register, login, logout, renewAccessToken, changePassword };
